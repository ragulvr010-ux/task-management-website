    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-80px)] px-4">
      ...
      >
        <div className="text-center">
          ...
          <p className="text-sm text-gray-400 mt-2">Get started with TaskFlow today</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-400">
          ...
          <Link to="/login" className="text-indigo-400 hover:text-indigo-350 font-medium transition-colors">
            Sign in
          </Link>
        </p>
      </form>
